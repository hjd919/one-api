...
func init() {
	flag.StringVar(&mchID, "m", "1643228653", "【必传】`商户号`")
	flag.StringVar(&mchSerialNo, "s", "18B1DEACC6C472155974CCA9C3309F26ECB58076", "【必传】`商户证书序列号`")
	flag.StringVar(&mchPrivateKeyPath, "p", "./wxcert/apiclient_key.pem", "【必传】`商户私钥路径`")
	flag.StringVar(&mchAPIv3Key, "k", "d9b61c63e570d90ee65ca32fada41fa0", "【必传】`商户APIv3密钥`")
